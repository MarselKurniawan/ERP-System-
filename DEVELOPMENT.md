...
```bash
git remote add encore encore://erp-accounting-system-goui
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/erp-accounting-system-goui/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/erp-accounting-system-goui/settings/integrations/github)
