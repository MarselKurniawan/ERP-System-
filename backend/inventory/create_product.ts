...
export const createProduct = api<CreateProductRequest, Product>(
  ...
  async (req) => {
    const product = await inventoryDB.queryRow<Product>`
      ...
      VALUES (${req.sku}, ${req.name}, ${req.description || null}, ${req.categoryId || null}, ${req.unitPrice}, ${req.costPrice}, ${req.stockQuantity || 0}, ${req.minStockLevel || 0}, ${req.maxStockLevel || null}, ${req.unit || 'pcs'})
